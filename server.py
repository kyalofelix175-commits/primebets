...
def get_fixtures():
    """Fetches up-to-date matches across all major upcoming leagues dynamically."""
    params = {
        'apiKey': ODDS_API_KEY, 
        'regions': 'eu', 
        'markets': 'h2h',
    ...
    try:
        ...
        if res.status_code != 200:
            print(f"Odds API Error Status: {res.status_code}, Response: {res.text}")
        
        if res.status_code == 200:
            raw_fixtures = res.json()
            processed = []
            
            # The API returns up to the next 8 matches across various competitions
            for item in raw_fixtures:
                ...
                # Default fallback odds if none are returned
                ...
                processed.append({
                    "id": item['id'],
                    "sport_title": item.get('sport_title', 'Soccer'), # e.g., "EPL" or "La Liga" 🏆
    ...
    mock_fixtures = [
        {"id": "mock_1", "sport_title": "English Premier League", "home_team": "Manchester City", "away_team": "Arsenal", "start_time": "2026-08-10T19:45:00Z", "is_live": False, "odds": {"home": 1.85, "away": 3.40}},
        {"id": "mock_2", "sport_title": "La Liga", "home_team": "Real Madrid", "away_team": "Barcelona", "start_time": "2026-08-11T20:00:00Z", "is_live": False, "odds": {"home": 2.15, "away": 2.95}},
        {"id": "mock_3", "sport_title": "UEFA Champions League", "home_team": "Bayern Munich", "away_team": "PSG", "start_time": "2026-08-12T20:00:00Z", "is_live": False, "odds": {"home": 1.95, "away": 3.10}}      
    ]
